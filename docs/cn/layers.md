...
| [core#banner](core/banner/)           | 这一模块为 SpaceVim 提供了许多可以默认显示在首页的功能块(banner)。                                                                  |
| [core#statusline](core/statusline/)   | 这一模块为 SpaceVim 提供了默认的模式化的状态栏支持。                                                                                |
| [core#tabline](core/tabline/)         | 这一模块为 SpaceVim 提供了一个更好的标签栏(tabline)。                                                                               |
| [core](core/)                         | 这一模块提供了启动 SpaceVim 及基本操作所必须的插件及配置。                                                                          |
...
| [default](default/)                   | 这一模块并不包含插件，但提供了一些更好的默认设置。                                                                                  |
