---
title: "Bundle 插件"
description: "SpaceVim Bundle  插件列表"
lang: zh
---

## Bundle 插件

在 `bundle/` 目录下，有两种插件，一种是直接上有下载下来后未作修改的插件，另外一类是基于某个版本做了修改的插件。
...
- `vim-startify`: based on [mhinz/vim-startify@4e089dffd](https://github.com/mhinz/vim-startify/tree/4e089dffdad46f3f5593f34362d530e8fe823dcf)
  - 使用 neomru 替代 v:oldfiles 解决文件重复及格式不一致问题。
