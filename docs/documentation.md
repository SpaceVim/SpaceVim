...
The first argument is the type of the key binding, which can be `nnoremap` or `nmap`,
The second argument is a list of keys.
The third argument is a ex-command or key binding, based on the last argument.
