...
function! SpaceVim#layers#cscope#config() abort
  ...
  if SpaceVim#layers#isLoaded('unite')
    let g:_spacevim_mappings_space.m.c.U = {'name' : '+Unite'}
    call SpaceVim#mapping#space#def('nnoremap', ['m', 'c', 'U', 'c'], 'Unite cscope/functions_called_by', 'find functions called by this function', 1)
    call SpaceVim#mapping#space#def('nnoremap', ['m', 'c', 'U', 'C'], 'Unite cscope/functions_calling', 'find functions calling this function', 1)
    call SpaceVim#mapping#space#def('nnoremap', ['m', 'c', 'U', 'd'], 'Unite cscope/global_definition', 'find global definition of a symbol', 1)
    call SpaceVim#mapping#space#def('nnoremap', ['m', 'c', 'U', 'r'], 'Unite cscope/find_this_symbol', 'find references of a symbol', 1)
    call SpaceVim#mapping#space#def('nnoremap', ['m', 'c', 'U', 'f'], 'Unite cscope/find_file', 'find files', 1)
    call SpaceVim#mapping#space#def('nnoremap', ['m', 'c', 'U', 'F'], 'Unite cscope/including_this_file', 'find files including this file', 1)
    call SpaceVim#mapping#space#def('nnoremap', ['m', 'c', 'U', 'e'], 'Unite cscope/egrep_pattern', 'Find this egrep pattern', 1)
    call SpaceVim#mapping#space#def('nnoremap', ['m', 'c', 'U', 't'], 'Unite cscope/text_string', 'find this text string', 1)
    call SpaceVim#mapping#space#def('nnoremap', ['m', 'c', 'U', '='], 'Unite cscope/assignments_to_symbol', 'find assignments to this symbol', 1)
  endif
endfunction
