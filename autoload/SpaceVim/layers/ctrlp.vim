...
function! SpaceVim#layers#ctrlp#plugins() abort
  let plugins = [
        ...
        \ ['wsdjeg/ctrlp-py-matcher', {'merged' : 0}],
        \ ['wsdjeg/ctrlp-register', {'on_cmd' : 'CtrlPRegister'}],
        \ ['wsdjeg/ctrlp-jumps', {'on_cmd' : 'CtrlPJump'}],
        \ ['SpaceVim/vim-ctrlp-help', {'on_cmd' : 'CtrlPHelp'}],
        \ ['wsdjeg/ctrlp-colorscheme', {'on_cmd' : 'CtrlPColorscheme'}],
        \ ]
