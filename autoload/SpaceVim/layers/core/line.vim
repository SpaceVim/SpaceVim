...
function! SpaceVim#layers#core#line#get() abort
...
function! SpaceVim#layers#core#line#config() abort
...
function! SpaceVim#layers#core#line#jump(id, ...) abort
  if get(a:000, 2, '') ==# 'm'
    if tabpagenr('$') > 1
      exe 'tabnext' . a:id
      quit
...
function! SpaceVim#layers#core#line#def_colors() abort
