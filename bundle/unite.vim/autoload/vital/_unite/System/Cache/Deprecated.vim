...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_unite#System#Cache#Deprecated#import() abort
  ...
  execute join(['function! vital#_unite#System#Cache#Deprecated#import() abort', printf("return map({'filereadable': '', '_vital_depends': '', 'delete': '', 'readfile': '', 'getfilename': '', 'deletefile': '', 'check_old_cache': '', 'writefile': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
" Note:
